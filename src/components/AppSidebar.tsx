  ...
  return (
    <Sidebar collapsible="icon">
      <SidebarHeader className="border-b border-sidebar-border px-4 py-4">
        <div className="flex items-center justify-between">
          {!collapsed && (
            <Link
              to="/dashboard"
              className="text-lg font-bold tracking-tight text-sidebar-foreground hover:opacity-80 transition-opacity"
          ...
          <button
            ...
            className="p-1 rounded-md text-sidebar-foreground/60 hover:text-sidebar-foreground hover:bg-sidebar-accent transition-colors active:scale-95"
          >
      ...
      <SidebarFooter className="border-t border-sidebar-border p-4">
        <div className="flex items-center gap-3">
          ...
          {!collapsed && (
            <div className="flex items-center gap-1">
              ...
              <button
                onClick={signOut}
                className="p-1.5 rounded-md text-sidebar-foreground/60 hover:text-destructive hover:bg-sidebar-accent transition-colors active:scale-95"
                title="Sign out"
              >
        ...
        {!collapsed && (
          <p className="text-[10px] text-sidebar-foreground/40 mt-2 text-center">⌘K to search</p>
        )}
      </SidebarFooter>
    </Sidebar>
  );
