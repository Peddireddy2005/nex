...
"web-development": {
  ...
  icon: <Code2 className="w-8 h-8 text-slate-900" />,
  intro: "Build fast, modern, and responsive websites tailored to your brand, business, and users.",
  roi: "Digital Growth",
  metricLabel: "Websites Delivered",
  problem: "Outdated, slow, or poorly designed websites can make businesses lose credibility, traffic, and potential customers.",
  solution: "Create high-performance websites with modern technologies, responsive designs, intuitive user experiences, and scalable architecture.",
  steps: [
    { label: "Define Requirements", desc: "Understand your business goals, target audience, features, and technical requirements." },
    { label: "Design & Develop", desc: "Create the UI and build the website using modern, scalable web technologies." },
    { label: "Launch & Optimize", desc: "Deploy the website, test performance, and continuously improve the user experience." }
  ]
}
};
