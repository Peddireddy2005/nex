    ...
    <div className="min-h-screen flex bg-background">
      <div className="hidden lg:flex lg:w-1/2 bg-card items-center justify-center p-12 border-r border-border">
        <div className="max-w-md space-y-6">
          <h1 className="text-4xl font-bold tracking-tight text-primary" style={{ lineHeight: '1.1' }}>NEXUBOTICS</h1>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-sm animate-fade-in-up">
          <div className="text-center mb-8 lg:hidden">
            <h1 className="text-3xl font-bold tracking-tight text-primary" style={{ lineHeight: '1.1' }}>NEXUBOTICS</h1>
          </div>
