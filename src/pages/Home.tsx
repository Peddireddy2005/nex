      ...
      <section className="py-20 px-6 max-w-7xl mx-auto border-b border-slate-200/50 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex justify-center">
            ...
            >
              <div className="liquid-glass rounded-[28px] relative overflow-hidden h-[440px] w-full z-10 flex flex-col">
                <div className="absolute top-0 left-0 w-full h-1 bg-brand-gradient z-10" />
                <div className="flex items-center gap-2.5 px-4 py-3 border-b border-slate-200/50 shrink-0">
                  <img src="/favicon.ico" alt="Nexubotics" className="w-6 h-6 object-contain" />
                  <span className="text-xs font-bold text-slate-900 font-display">Nexubotics AI Assistant</span>
                </div>
                <iframe
