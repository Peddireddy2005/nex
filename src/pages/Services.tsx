...
import { MessageSquare, Zap, Users, Cpu, BrainCircuit, ArrowRight, Target, Check, Code2 } from "lucide-react";
...
const SERVICES = [
  ...
  {
    id: "web-development",
    icon: <Code2 className="group-hover-pulse-gentle" />,
    title: "Web Development",
    problem: "Outdated, slow, or poorly designed websites that fail to engage users and convert visitors into customers.",
    solution: "Build modern, responsive, high-performance websites tailored to your brand, business goals, and user needs.",
    benefits: ["Responsive modern design", "High-performance development", "Scalable & SEO-friendly"],
